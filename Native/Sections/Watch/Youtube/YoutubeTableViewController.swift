...
class YoutubeTableViewController: UITableViewController {
    ...
    private func loadYoutubeVideos() {
        ...
        let video2 = YoutubeVideo(id: "tXwQWZEHnwY", title: "NBA Game Time | Kevin Mchale analyze and predict: Lakers vs Spurs | Who wins tonight?", source: "First Take ESPN", description: "NBA Game Time | Kevin Mchale analyze and predict: Lakers vs Spurs | Who wins tonight?")
